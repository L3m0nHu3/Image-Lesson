...
void setup() {
  ...
  //
  //Population of Image
  pic1 = loadImage("../Images Used/Landscape & Square Images/CoolLiminalSpace2.jpeg"); //Dimensions: width 750, height 750
  pic2 = loadImage("../Images Used/Landscape & Square Images/LiminalSpaces3.jpg"); //Dimensions: width 800, height 600
