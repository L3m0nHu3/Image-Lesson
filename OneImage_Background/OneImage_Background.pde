...
void setup () {
  ...
  //
  //Population of Image
  pic = loadImage("/Users/danielhamilton/Documents/GitHub/Image-Lesson/Images Used/Landscape & Square Images/CoolLiminalSpace2.jpeg"); //Dimensions: width 750, height 750
  ...
  //Aspect Ratio
  //Note: single line IFs can be summarized into
